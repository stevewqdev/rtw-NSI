                                        ...
                                        <form method="post" action="https://www.tfaforms.com/responses/processor" className="hintsBelow labelsAbove" id={4696781} role="form">
                                            <Slider {...settings} ref={c => (this.slider = c)}>
                                                ...
                                                <div className="form__step form__step__two">
                                                    ...
                                                    <div id="tfa_2716" className="section inline group">
                                                        ...
                                                        <label id="tfa_2627-L" className="label preField reqMark" htmlFor="tfa_2627">Credit Card Type</label><br /><div className="inputWrapper"><select id="tfa_2627" name="tfa_2627" title="Credit Card Type" aria-required="true" className="required">
                                                            <option value="tfa_2628" id="tfa_2628" className selected>Visa</option>
                                                        ...
                                                        <label id="tfa_2528-L" className="label preField reqMark" htmlFor="tfa_2528">MM</label><br /><div className="inputWrapper"><input  type="text" id="tfa_2528" name="tfa_2528" defaultValue maxLength={2} aria-required="true" min={1} max={12} title="MM" className="validate-integer required" /></div>
                                                        </div>
                                                        <div className="oneField field-container-D    " id="tfa_2529-D">
                                                        <label id="tfa_2529-L" className="label preField reqMark" htmlFor="tfa_2529">YY</label><br /><div className="inputWrapper"><input  type="text" id="tfa_2529" name="tfa_2529" defaultValue maxLength={2} aria-required="true" max={9999} title="YY" className="validate-integer required" /></div>
                                                        </div>
                                                        <div className="oneField field-container-D    " id="tfa_2530-D">
                                                        <label id="tfa_2530-L" className="label preField reqMark" htmlFor="tfa_2530">Code</label><br /><div className="inputWrapper"><input  type="text" id="tfa_2530" name="tfa_2530" defaultValue aria-required="true" title="Code" className="required" /></div>
                                                        </div>
                                                        ...
                                                        <div className="oneField field-container-D    " id="tfa_2439-D">
                                                            <label id="tfa_2439-L" className="label preField reqMark" htmlFor="tfa_2439">State</label><br /><div className="inputWrapper"><select id="tfa_2439" name="tfa_2439" data-condition="`#tfa_2425` OR `#tfa_2426`" title="State" aria-required="true" className="required">
                                                                ...
                                                                <option value="tfa_2440" id="tfa_2440" className select>Alabama</option>
                                                ...
                                                <div className="form__step form__step__three">
                                                    ...
                                                    <input  type="hidden" id="tfa_2625" name="tfa_2625" defaultValue className="formula=100*total" /><input  type="hidden" id="STRIPE_CUSTOMER_274127" name="STRIPE_CUSTOMER_274127" defaultValue className /><input  type="hidden" id="STRIPE_SUBSCR_274127" name="STRIPE_SUBSCR_274127" defaultValue className /><input  type="hidden" id="STRIPE_CHARGE_274127" name="STRIPE_CHARGE_274127" defaultValue className /><input  type="hidden" id="tfa_2626" name="tfa_2626" defaultValue className /><div id="Paypal_Hidden_Fields" className="section column group wf-acl-hidden">
                                                    ...
                                                    <input  type="hidden" defaultValue={4696781} name="tfa_dbFormId" id="tfa_dbFormId" /><input  type="hidden" defaultValue name="tfa_dbResponseId" id="tfa_dbResponseId" /><input  type="hidden" defaultValue="456681eb362897875a1b544075626721" name="tfa_dbControl" id="tfa_dbControl" /><input  type="hidden" defaultValue={132} name="tfa_dbVersionId" id="tfa_dbVersionId" /><input  type="hidden" defaultValue name="tfa_switchedoff" id="tfa_switchedoff" />
                                                </div>
                                            </Slider>
