                                                                    ...
                                                                    <div className="inputWrapper">
                                                                        <span id="tfa_16" className="choices horizontal required">
                                                                            <span className="oneChoice is__toggled">
                                                                                <input onClick={this.toggleFrequency}  type="radio" defaultValue="tfa_17" value="tfa_17" className="calc-payments calcval-1"  id="tfa_17" name="tfa_16" aria-required="true" data-conditionals="#tfa_2720" aria-labelledby="tfa_17-L" data-tfa-labelledby="tfa_16-L tfa_17-L" checked  />
