...
function MyApp({ Component, pageProps }) {
    ...
    return (
        <div>
            ...
            <Header menuItems={pageProps.mainMenu} masterElements={pageProps.masterElements} />
            <Component {...pageProps} />
            <Footer customClass={'bottom'} menuItems={pageProps.mainMenu} masterElements={pageProps.masterElements} />
        </div>
    )
}
