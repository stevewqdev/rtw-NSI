...
var apiCall = $.getJSON(`${apiLink}`, function(data) {
    ...
    for (let index = 0; index < data.length; index++) {
        ...
        if(element.Display_Name__c === '' || element.Display_Name__c === null || element.Display_Name__c === undefined){
            element.Display_Name__c = 'Event title is not available';
        }
    ...
    for (let index = 0; index < issueElements.length; index++) {
        ...
        finalOption = finalOption.replace(/ /g, '').replace(/,/g, '').replace(/-/g, '').replace(/!/g, '').replace(/&/g, '').replace("(", '').replace("[", '').replace("]", '').replace("'", '').replace("`", '').replace("!", '').replace("?", '').replace(";", '').replace(")", '').replace(/#/g, '').replace(/'/g, '').replace(/\//g, '').replace(/\./g, '').toLowerCase(); 
...
function formatDataEvents(data, searchData = null, removedTag = null, TimeRange = false){
    ...
    if($('.location_get').length || $('.issue_get').length || $('.partner_get').length || $('.date_get .start').length || $('.type_get').length ){
        ...
        if($('.location_get').length){
            ...
            city = city.replace(/ /g, '').replace(/↵/g, '').replace(/,/g, '').replace(/\//g, '').replace(/\./g, '').replace(/\\n/g, '').replace(/\n/g, '').replace(/-/g, '').replace(/&/g, '').replace("(", '').replace("[", '').replace("]", '').replace("'", '').replace("`", '').replace("!", '').replace("?", '').replace(";", '').replace(")", '').replace(/#/g, '').replace(/'/g, '').replace(/!/g, '').toLowerCase();
    ...
    if( searchData[0] === null &&  searchData[1] === undefined   && searchData[2] === null && searchData[3][0] === null  && searchData[4] === "-1" && searchData[5] === null){
        ...
        for (let index = 0; index < info.length; index++) {
            ...
            cardContext.forEach(element => {
                element = element.replace(/ /g, '')
                                 ...
                                 .replace(/\./g, '')
                                 .replace(/-/g, '')
                                 .replace(/&/g, '').replace("(", '').replace("[", '').replace("]", '').replace("'", '').replace("`", '').replace("!", '').replace("?", '').replace(";", '').replace(")", '').replace(/#/g, '').replace(/'/g, '')
                                 .replace(/!/g, '')
                                 .toLowerCase();
        ...
        onGoingCards = new Array();
            for (let index = 0; index < info.length; index++) {
                ...
                // Clean, remove spaces and lowercase the info
                theIssue = theIssue.replace(/ /g, '').replace(/&/g, '').replace("(", '').replace("[", '').replace("]", '').replace("'", '').replace("`", '').replace("!", '').replace("?", '').replace(";", '').replace(")", '').replace(/#/g, '').replace(/'/g, '').replace(/-/g, '').replace(/!/g, '').replace(/,/g, '').replace(/\//g, '').replace(/\./g, '').toLowerCase();
                
                let theCity = data.city;
                
                // Clean, remove spaces and lowercase the info
                theCity = theCity.replace(/ /g, '').replace(/&/g, '').replace("(", '').replace("[", '').replace("]", '').replace("'", '').replace("`", '').replace("!", '').replace("?", '').replace(";", '').replace(")", '').replace(/#/g, '').replace(/'/g, '').replace(/-/g, '').replace(/!/g, '');theCity = theCity.replace(/,/g, '');theCity = theCity.replace(/\//g, '');theCity = theCity.replace(/\./g, '').toLowerCase();    

                let theContext = data.context;
                // Clean, remove spaces and lowercase the info
                theContext = theContext.replace(/ /g, '').replace(/&/g, '').replace("(", '').replace("[", '').replace("]", '').replace("'", '').replace("`", '').replace("!", '').replace("?", '').replace(";", '').replace(")", '').replace(/#/g, '').replace(/'/g, '').replace(/-/g, '').replace(/!/g, '');theContext = theContext.replace(/,/g, '');theContext = theContext.replace(/\//g, '');theContext = theContext.replace(/\./g, '').toLowerCase();
                
                let thePartner = data.partner;
                // Clean, remove spaces and lowercase the info
                thePartner = thePartner.replace(/ /g, '').replace(/&/g, '').replace("(", '').replace("[", '').replace("]", '').replace("'", '').replace("`", '').replace("!", '').replace("?", '').replace(";", '').replace(")", '').replace(/#/g, '').replace(/'/g, '').replace(/-/g, '').replace(/!/g, '');thePartner = thePartner.replace(/,/g, '');thePartner = thePartner.replace(/\//g, '');thePartner = thePartner.replace(/\./g, '').toLowerCase();
                ...
                var formatedContext = new Array();
                cardContext.forEach(element => {
                    element = element.replace(/ /g, '').replace(/,/g, '').replace(/\//g, '').replace(/\./g, '').replace(/&/g, '').replace("(", '').replace("[", '').replace("]", '').replace("'", '').replace("`", '').replace("!", '').replace("?", '').replace(";", '').replace(")", '').replace(/#/g, '').replace(/'/g, '').replace(/-/g, '').replace(/!/g, '').toLowerCase();
                    formatedContext.push(element);
                });
