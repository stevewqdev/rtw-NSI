...
var apiCall = $.getJSON(`${apiLink}`, function(data) {
    ...
    for (let index = 0; index < issueElements.length; index++) {
        ...
        finalOption = finalOption.replace(/ /g, '').replace(/,/g, '').replace(/-/g, '').replace(/!/g, '').replace(/&/g, '').replace(/'/g, '').replace(/\//g, '').replace(/\./g, '').toLowerCase(); 
...
function curatedCards(data, searchData = null, removedTag = null){
    ...
    if( searchData[0] === null &&  searchData[1] === undefined   && searchData[2] === null && searchData[3][0] === null  && searchData[4] === "-1" && searchData[5] === null){
        ...
        for (let index = 0; index < info.length; index++) {
            ...
            // Clean, remove spaces and lowercase the info
            theIssue = theIssue.replace(/ /g, '').replace(/,/g, '').replace(/&/g, '').replace(/'/g, '').replace(/-/g, '').replace(/\//g, '').replace(/\./g, '').replace(/-/g, ''.replace(/&/g, '')).replace(/'/g, '').replace(/!/g, '').toLowerCase();
            
            let theCity = data.city;
            // Clean, remove spaces and lowercase the info
            theCity = theCity.replace(/ /g, '');theCity = theCity.replace(/,/g, ''.replace(/&/g, '')).replace(/'/g, '').replace(/-/g, '');theCity = theCity.replace(/\//g, '').replace(/-/g, '').replace(/&/g, '').replace(/'/g, '').replace(/!/g, '');theCity = theCity.replace(/\./g, '').toLowerCase();               
    
            let theContext = data.context;
            // Clean, remove spaces and lowercase the info
            theContext = theContext.replace(/ /g, '').replace(/&/g, '').replace(/'/g, '').replace(/-/g, '');theContext = theContext.replace(/,/g, '').replace(/-/g, ''.replace(/&/g, '')).replace(/'/g, '').replace(/!/g, '');theContext = theContext.replace(/\//g, '');theContext = theContext.replace(/\./g, '').toLowerCase();
            

            let thePartner = data.partner;
            // Clean, remove spaces and lowercase the info
            thePartner = thePartner.replace(/ /g, '').replace(/&/g, '').replace(/'/g, '').replace(/-/g, '');thePartner = thePartner.replace(/,/g, '').replace(/-/g, ''.replace(/&/g, '')).replace(/'/g, '').replace(/!/g, '');thePartner = thePartner.replace(/\//g, '');thePartner = thePartner.replace(/\./g, '').toLowerCase();
        ...
        onGoingCards = new Array();
            for (let index = 0; index < info.length; index++) {
                ...
                // Clean, remove spaces and lowercase the info
                theIssue = theIssue.replace(/ /g, '').replace(/&/g, '').replace(/'/g, '').replace(/-/g, '').replace(/!/g, '').replace(/,/g, '').replace(/\//g, '').replace(/\./g, '').toLowerCase();
                
                let theCity = data.city;
                
                // Clean, remove spaces and lowercase the info
                theCity = theCity.replace(/ /g, '').replace(/&/g, '').replace(/'/g, '').replace(/-/g, '').replace(/!/g, '');theCity = theCity.replace(/,/g, '');theCity = theCity.replace(/\//g, '');theCity = theCity.replace(/\./g, '').toLowerCase();    

                let theContext = data.context;
                // Clean, remove spaces and lowercase the info
                theContext = theContext.replace(/ /g, '').replace(/&/g, '').replace(/'/g, '').replace(/-/g, '').replace(/!/g, '');theContext = theContext.replace(/,/g, '');theContext = theContext.replace(/\//g, '');theContext = theContext.replace(/\./g, '').toLowerCase();
                
                let thePartner = data.partner;
                // Clean, remove spaces and lowercase the info
                thePartner = thePartner.replace(/ /g, '').replace(/&/g, '').replace(/'/g, '').replace(/-/g, '').replace(/!/g, '');thePartner = thePartner.replace(/,/g, '');thePartner = thePartner.replace(/\//g, '');thePartner = thePartner.replace(/\./g, '').toLowerCase();
                ...
                var formatedContext = new Array();
                cardContext.forEach(element => {
                    element = element.replace(/ /g, '').replace(/,/g, '').replace(/\//g, '').replace(/\./g, '').replace(/&/g, '').replace(/'/g, '').replace(/-/g, '').replace(/!/g, '').toLowerCase();
                    formatedContext.push(element);
                });
