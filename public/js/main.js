...
var apiCall = $.getJSON(`${apiLink}`, function(data) {
    ...
    for (let index = 0; index < issueElements.length; index++) {
        ...
        finalOption = finalOption.replace(/ /g, '').replace(/,/g, '').replace(/-/g, '').replace(/!/g, '').replace(/&/g, '').replace("(", '').replace("[", '').replace("]", '').replace("'", '').replace("`", '').replace("!", '').replace("?", '').replace(";", '').replace(")", '').replace(/#/g, '').replace(/'/g, '').replace(/\//g, '').replace(/\./g, '').replace("@", '').replace("#", '').replace("$", '').replace("%", '').replace("^", '').replace("*", '').replace("_", '').replace("+", '').replace("<", '').replace(">", '').replace("§", '').replace("±", '').toLowerCase(); 
    ...
    if( searchData[0] === null &&  searchData[1] === undefined   && searchData[2] === null && searchData[3][0] === null  && searchData[4] === "-1" && searchData[5] === null){
        ...
        onGoingCards = new Array();
            for (let index = 0; index < info.length; index++) {
                ...
                // Clean, remove spaces and lowercase the info
                theIssue = theIssue.replace(/ /g, '').replace(/&/g, '').replace("(", '').replace("[", '').replace("]", '').replace("'", '').replace("`", '').replace("!", '').replace("?", '').replace(";", '').replace(")", '').replace(/#/g, '').replace(/'/g, '').replace(/-/g, '').replace(/!/g, '').replace(/,/g, '').replace(/\//g, '').replace(/\./g, '').replace("@", '').replace("#", '').replace("$", '').replace("%", '').replace("^", '').replace("*", '').replace("_", '').replace("+", '').replace("<", '').replace(">", '').replace("§", '').replace("±", '').toLowerCase();
                ...
                let theContext = data.context;
                // Clean, remove spaces and lowercase the info
                theContext = theContext.replace(/ /g, '').replace(/&/g, '').replace("(", '').replace("[", '').replace("]", '').replace("'", '').replace("`", '').replace("!", '').replace("?", '').replace(";", '').replace(")", '').replace(/#/g, '').replace(/'/g, '').replace(/-/g, '').replace(/!/g, '');theContext = theContext.replace(/,/g, '');theContext = theContext.replace(/\//g, '');theContext = theContext.replace(/\./g, '').replace("@", '').replace("#", '').replace("$", '').replace("%", '').replace("^", '').replace("*", '').replace("_", '').replace("+", '').replace("<", '').replace(">", '').replace("§", '').replace("±", '').toLowerCase();
                
                let thePartner = data.partner;
                // Clean, remove spaces and lowercase the info
                thePartner = thePartner.replace(/ /g, '').replace(/&/g, '').replace("(", '').replace("[", '').replace("]", '').replace("'", '').replace("`", '').replace("!", '').replace("?", '').replace(";", '').replace(")", '').replace(/#/g, '').replace(/'/g, '').replace(/-/g, '').replace(/!/g, '');thePartner = thePartner.replace(/,/g, '');thePartner = thePartner.replace(/\//g, '');thePartner = thePartner.replace(/\./g, '').replace("@", '').replace("#", '').replace("$", '').replace("%", '').replace("^", '').replace("*", '').replace("_", '').replace("+", '').replace("<", '').replace(">", '').replace("§", '').replace("±", '').toLowerCase();
                ...
                var formatedContext = new Array();
                cardContext.forEach(element => {
                    element = element.replace(/ /g, '').replace(/,/g, '').replace(/\//g, '').replace(/\./g, '').replace("@", '').replace("#", '').replace("$", '').replace("%", '').replace("^", '').replace("*", '').replace("_", '').replace("+", '').replace("<", '').replace(">", '').replace("§", '').replace("±", '').replace(/&/g, '').replace("(", '').replace("[", '').replace("]", '').replace("'", '').replace("`", '').replace("!", '').replace("?", '').replace(";", '').replace(")", '').replace(/#/g, '').replace(/'/g, '').replace(/-/g, '').replace(/!/g, '').toLowerCase();
                    formatedContext.push(element);
                });
